...
public class LoginActivity extends AppCompatActivity {
    ...
    public void btnIngresar(View view){
        ...
        if(ConnectivityReceiver.isConnected(this)){
                ...
                public void onResponse(String response) {
                    try {
                        if (response.equals("[]")){
                            progressBar.setVisibility(View.INVISIBLE);
                            getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
                            Toast.makeText(getApplicationContext(), "Usuario y Password invalidos", Toast.LENGTH_LONG).show();
                        }else{
            ...
            Toast toast = Toast.makeText(this, "Necesitas contectarte a internet para continuar", Toast.LENGTH_LONG);
