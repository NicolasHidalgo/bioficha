...
public class DatabaseManagerSedePoligono extends DatabaseManager {
    ...
    public void actualizar(SedePoligonoBean obj) {
        ...
        String [] args = new String[]{obj.getID_SEDE()};
        Log.d(NOMBRE_TABLA + "_actualiza",super.getDb().update(NOMBRE_TABLA,valores, CN_ID_SEDE+ "=?", args)+"");
    }

    @Override
    public void eliminar(String id) {
        super.getDb().delete(NOMBRE_TABLA,CN_ID_SEDE+ "=?", new String[]{id});
    }
    ...
    public Cursor cargar() {
        String [] columnas = new String[]
                {CN_LATITUD,CN_LONGITUD,CN_ID_SEDE};
    ...
    public Cursor cargarById(String id) {
        String [] columnas = new String[]
                {CN_LATITUD,CN_LONGITUD,CN_ID_SEDE};
        return super.getDb().query(NOMBRE_TABLA, columnas,CN_ID_SEDE + "=?", new String[]{id},null,null,null);
    }
    ...
    public Boolean compruebaRegistro(String id) {
        boolean existe = true;
        Cursor resultSet = super.getDb().rawQuery("Select * from " + NOMBRE_TABLA + " WHERE " + CN_ID_SEDE + " =" + id, null);
    ...
    public List<SedePoligonoBean> getList(String tipo){
        ...
        while (c.moveToNext()){
            ...
            bean.setLATITUD(c.getDouble(0));
            bean.setLONGITUD(c.getDouble(1));
            bean.setID_SEDE(c.getString(2));
            list.add(bean);
        }
        return list;
    }
